        ...
        "
          >
            ...
            <h1 className="text-center text-2xl sm:text-4xl font-bold  sm:w-100 sm:text-start">
              Various <span className="text-blue-500">new collections</span>{" "}
              image of furniture to decorate the corner of your house.
            </h1>
        ...
        <section className="mt-20">
          ...
          <div className="flex justify-center">
            <div className="grid gap-6 grid-cols-[repeat(auto-fit,_minmax(250px,_1fr))] px-4">
              <Products imageUrl={"Images/product.png"} />
              <Products imageUrl={"Images/product-1.png"} />
              <Products imageUrl={"Images/product-2.png"} />
              <Products imageUrl={"Images/product-3.png"} />
              <Products imageUrl={"Images/product-4.png"} />
              <Products imageUrl={"Images/product-5.png"} />
              <Products imageUrl={"Images/product-6.png"} />
              <Products imageUrl={"Images/product-1.png"} />
            </div>
          </div>
        </section>
